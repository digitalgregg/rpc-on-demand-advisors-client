    ...
    return (
        <div className="relative">
            <Link href={`/dashboard/collections/view-contents/${data.id}`}>
                <div className="w-full  h-[121px] bg-[#FFFFFF] relative rounded-[4px]  shadow-[0px_2px_25px_rgba(0,0,0,0.06)] hover:shadow-[0px_2px_20px_rgba(229,25,55,0.2)] border border-transparent  transition ease-in-out duration-200 hover:border hover:border-primary px-[20px] py-[20px]">
                ...
                {dropdownOpen && (
                    <div className="absolute top-[44px]  right-[31px] w-[111px] h-[70px] z-50 shadow-[4px_4px_8px_rgba(0,0,0,0.25)] bg-white  flex items-center justify-center px-[10px]">
                        <ul className="w-full  ">
                            ...
                            >
                                <li className="flex group gap-[18px] items-center mb-[12px] text-[14px] px-2 py-[2px]  transition ease-in-out duration-200 hover:bg-[rgba(229,25,55,0.1)] cursor-pointer ">
                            ...
                            <li className="flex gap-[18px] items-center  transition ease-in-out duration-200 text-[14px] hover:bg-[rgba(229,25,55,0.1)] px-2 group py-[2px] cursor-pointer">
                                <DeleteIcon
                                    stroke="#E51937"
                                    width="12px"
                                    height="12px"
