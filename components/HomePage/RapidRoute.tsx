    ...
    <div className="w-[100%] bg-[#F8F8F8] py-[60px] lg:py-[80px]">
      <div className="container flex flex-col items-center lg:flex-row-reverse xs:w-[375px] sm:w-[680px] md:w-[768px] lg:w-[1024px] xl:w-[1200px] 2xl:w-[1440px] 3xl:w-[1680px] 4xl:w-[1920px]">
        <div className="flex-col lg:w-[404.54px] xl:w-[461.13px] 2xl:w-[537.87px] 3xl:w-[589.61px] 4xl:w-[572px]">
          ...
          <p className={pStyle}>
            Most sales enablement tools and content management solutions are
            overly complicated and too complex to quickly roll out to your team.
          </p>
          <br />
          <p className={pStyle}>
            With ODA Center as your sales enablement tool, you’ll give everyone
            access to content that converts – wherever they are working – with
            our Browser Extensions. Zero training overhead and easy set up mean
