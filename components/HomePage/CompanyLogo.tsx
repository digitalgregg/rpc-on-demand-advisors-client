  ...
  return (
    <div className="w-[100%] xs:mt-[40px] md:mt-[60px] xs:mb-[20px] sm:mb-[40px] md:mb-[60px] lg:mt-[80px] lg:mb-[80px]">
     <div className="container ">
      <h3 className="xs:text-[16px] sm:text-[28px] 2xl:text-[32px] 2xl:leading-[43.58px] font-bold xs:leading-[21.79px] mb-[20px] sm:mb-[40px] sm:leading-[38.13px] sm:px-12 text-center text-[#1D1D1D]">Built for your current marketing and sales stack</h3>
