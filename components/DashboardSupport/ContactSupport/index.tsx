...
const ContactSupport = () => {
    return (
        <div className=" flex flex-col lg:flex-row ">
            <div>
                <h1 className=" text-2xl leading-[33px] font-semibold text-[#000000] mb-[20px]">Questions. We all have them.</h1>
                <p className={stypes}>
                    We’re available to connect and talk about sales enablement,
                    go to market, and answer anything you want to know about the
                    product.
                </p>
                <p className={stypes}>
