...
const ContentCard = ({
  ...
  const buttonSyle =
    "w-[72.25px] h-[30px] sm:w-[121px] sm:h-[30px] md:w-[140.5px] lg:w-[75.88px] xl:w-[95.38px] 2xl:w-[79.5px] 3xl:w-[95.17px] 4xl:w-[81.94px] rounded-[4px] border border-[#E51937] text-[12px] font-semibold	text-[#E51937] hover:bg-[#E51937] hover:text-[#FFFFFF]";
  ...
  return (
    <div
      ...
      className="w-[335px] h-[175px] sm:w-[530px] sm:h-[175px] md:w-[608px] md:h-[175px] lg:w-[349.5px] lg:h-[175px] xl:w-[427.5px] xl:h-[175px] 2xl:w-[350px] 2xl:h-[175px] 3xl:w-[426.67px]  4xl:w-[373px] bg-[#FFFFFF] rounded-[4px] p-[10px] relative"
    >
