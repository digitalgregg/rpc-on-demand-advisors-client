...
const ContentCard = ({
  ...
  const buttonSyle =
    " h-[30px]  sm:h-[30px] w-[48%] rounded-[4px] border transition ease-in-out duration-200 border-[#E51937] text-[12px] font-semibold	text-[#E51937] hover:bg-[#E51937] hover:text-[#FFFFFF]";
