                            ...
                            {() => (
                                <Form>
                                    <div className="bg-white_secondary p-[10px] rounded-lg flex flex-col gap-[20px]">
                                        <div className=" flex flex-row items-end w-full gap-[20px]">
                                            ...
                                            <div
                                                className={`shadow rounded overflow-hidden h-[55px] !p-0 !w-[220px] flex flex-row items-center gap-[10px] border border-solid border-[#DEDEDE] bg-White`}
                                            >
                                                <InputField
                                                    inputClass=" !w-[30px] !p-0 !mt-[6px] !border-none !text-[14px] !font-normal !leading-[19px] !text-[#676767] input-color-rounded-[4px] input-color-padding rounded-[4px] !outline-none !border-none"
                                                ...
                                                <span
                                                    className={`capitalize text-sm font-normal leading-[19px] text-[#000805]`}
                                                >
                                                    {props.color}
                                                </span>
                                            </div>
