    ...
    return (
        <div className=" rounded-[10px] bg-White w-full overflow-hidden">
            ...
            <div className="flex flex-col gap-5 p-5 ">
                <p className="text-sm leading-[19.07px] sm:text-base sm:leading-[21.79px] font-normal text-[#222222]">
                ...
                <p className=" text-sm leading-[19.07px] sm:text-base sm:leading-[21.79px] font-normal text-[#222222] text-center">
