  ...
  return (
    <div className="w-full">
      ...
      <input
        ...
        className="w-full border border-[#9E9E9E] outline-0 rounded-[4px] px-[15px] h-[55px] text-[#676767] text-[14px] mt-[10px] mb-[20px]"
      />
      <label htmlFor="description"><span className={labelStyle}>Description</span></label>
      <textarea className="w-full h-[150px] border border-[#9E9E9E] rounded-[4px] mt-[10px] outline-0 px-[15px] text-[14px] text-[#676767] leading-[19.07px] py-[18px]"></textarea>
    </div>
  );
};
