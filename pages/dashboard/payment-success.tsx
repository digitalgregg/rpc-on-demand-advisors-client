...
export default function Index() {
  const { email } = getLocal("user-info");
  ...
  useEffect(() => {
    ...
    api.post("/api/billing-details", { price, email });
  }, []);
  return (
    <div className="w-[100%] h-[100vh] modal-scroll">
      ...
      <div className="w-[100%] flex flex-col justify-center items-center xs:h-[80vh] md:h-[88vh] lg:h-[90vh] xl:h-[95vh] 2xl:h-[90vh]">
        ...
        <Link href="/dashboard/billing/payment">
          <button className="bg-[#E51937] mb-[5px] text-[#FFFFFF] xs:w-[160px] xs:h-[44px] lg:w-[200px] lg:h-[48px] xl:w-[230px] rounded-[4px] xs:text-[14px] lg:text-[18px] font-semibold cursor-pointer">
            Back to home
          </button>
        </Link>{" "}
      </div>
