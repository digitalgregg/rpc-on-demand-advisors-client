...
const questionsData: QuestionsDataType[] = [
  {
    ...
    answer:
      "No. Unlike some enterprise competitors, there are no setup fees on any of our plans.",
  },
  {
    question: "Do I need to enter payment details to sign up?",
    answer:
      "Nope. You can sign up and use Content Camel for 14 days without entering your payment details. At the end of your trial, or when you decide to go live with ODA Center, you will need to pick a plan and enter your payment details.",
  },
  {
    question: "How long does it take to get started?",
    answer:
      "Yes. If you ever decide that ODA Center isn’t the best platform for your business, simply cancel your account. We don’t lock you into annual or multi-year plans.",
  },
  {
    question: "How long does it take to get started?",
    answer:
      "Unlike other sales enablement tools, you’ll be up and running with ODA Center as fast as you are ready. While others may take 90+ days to get going (looking at you Showpad), our customers are typically rolling ODA Center out to their teams within the week!",
  },
  {
    question:
      "Can we get help migrating off of (Highspot, Showpad, Brainshark, Google Drive?",
    answer:
      "It’s easy to import content directly into ODA Center, and we’re happy to show you around to get you and your team going. If you need more help migrating off your existing solution, just give us a shout.",
  },
  {
    question: "Is the Solo plan really free?",
    answer:
      "Yes. Our free plan is designed for sellers operating solo or looking to outperform their colleagues within an organization that hasn’t fully rolled out sales enablement to everyone (yet). We love the hustlers and the go-getters out there.",
  },
  {
    question: "How long are your contracts?",
    answer:
      "All ODA Center plans are month to month unless you sign up for a discounted annual plan.",
  },
  {
    question: "Do you offer any discounted plans?",
    answer:
      "Yes, we offer a 15% discount on annual plans when they are paid upfront.",
  },
        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row gap-[30px] lg:gap-[21px] xl:gap-[30px] sm:gap-[40px] items-center relative top-[-400px] sm:top-[-482px] md:top-[-442px] md:mb-[-442px] lg:justify-center lg:top-[-421px] xl:top-[-401px] 4xl:top-[-381px] mb-[-400px] sm:mb-[-482px] lg:mb-[-421px] xl:mb-[-401px] 4xl:mb-[-381px]">
            {pricingCardData.map((v, i) =>
              toggle ? (
                i != 0 && <PricingCard key={i} data={v} isAnnual={toggle} />
              ) : (
                <PricingCard key={i} data={v} isAnnual={toggle} />
              )
            )}
          </div>
        </div>
          ...
          <div className="flex flex-col sm:flex-row-reverse items-center sm:justify-between py-[40px] sm:pt-[58px] sm:py-[40px] lg:py-[80px] xl:py-[92px] xl:px-[57px] 2xl:px-[84px] 3xl:px-[230px] 4xl:px-[290px]">
            ...
            <div className="basis-[60%] md:basis-1/2">
              ...
              <div className="text-[#101010]   max-xs:w-[314px] text-[14px] leading-[19px] text-center sm:text-left font-normal">
                ...
                Smoother buyer’s journey. Close more deals
              </div>
  ...
  return (
    ...
    >
      <div className="flex items-center">
        <img
          src={`/assets/pricing-page/${isExpand ? "remove" : "add"}.svg`}
          alt=""
