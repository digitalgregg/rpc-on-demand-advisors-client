            ...
            <div>
              <div className="font-primary ">
                ...
                <p className="text-sm sm:leading-[19.07px] leading-[21px] md:leading-[21.79px] md:text-base  text-center text-[#dedede] sm:mx-[40.42px]  md:mx-[79px] ">
                  Take control of your Google Drive, Dropbox, and SharePoint
        ...
        <div className="bg-[#fff]">
          <div className="container mx-auto">
            ...
            <div className="text-[#4f4f4f] font-normal text-sm leading-[21px] text-center px-[1px] sm:leading-[19.07px] sm:px-[35.5px] md:px-0 lg:px-[157px] lg:leading-[28px] lg:text-base xl:px-[232px] 3xl:px-[412px] 3xl:leading-[21.79px] 4xl:px-[472px]">
              Go beyond Drive folders to get organized, deliver powerful
              notifications to Sales, engage buyers, and make decisions with the
              analytics you need to succeed with your already winning content.
            </div>
          ...
          <div className="container mx-auto">
            {expandContentData.map((v, i) => (
              <SectionContent
                ...
                border={expandContentData.length == i + 1 ? false : true}
                onClick={() => setExpandContent(expandContent == i ? -1 : i)}
              />
            ))}
          </div>
        </div>
          ...
          <div className="container mx-auto">
            <div className="flex items-center flex-col py-5 sm:py-[60px] sm:mb-[45px] md:my-[60px] xl:my-[30px]">
              ...
              <div className="text-[#9E9E9E] text-center text-sm leading-[20px] sm:text-[#FAFAFA] sm:leading-[21px] lg:px-[157px] lg:text-base xl:leading-[28px] 4xl:px-[434px] 3xl:px-[373px] 2xl:px-[291px] xl:px-[231px] ">
                Easy to set up. Easy to roll out. Instant adoption across Sales
                and Marketing. Discover how ODA Center can help you drive more
                value from your content and close deals faster.
              </div>
          ...
          <div className="container mx-auto">
            {expandContentData2.map((v, i) => (
              <SectionContent
                ...
                border={expandContentData2.length == i + 1 ? false : true}
                onClick={() => setExpandContent2(expandContent2 == i ? -1 : i)}
              />
            ))}
          </div>
        </div>
          ...
          <div className="container mx-auto">
            {expandContentData3.map((v, i) => (
              <SectionContent
                ...
                border={expandContentData3.length == i + 1 ? false : true}
                onClick={() => setExpandContent3(expandContent3 == i ? -1 : i)}
              />
            ))}
          </div>
