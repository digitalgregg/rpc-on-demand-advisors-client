                            ...
                            <div className="font-primary ">
                                ...
                                <div className="flex gap-5  justify-center relative z-10 text-[#fff]">
                                    <button
                                        ...
                                        className="text-sm font-semibold text-center w-[158px] h-[44px] sm:h-[56px] bg-primary hover:bg-[#890F21] border border-primary leading-[19.07px] sm:leading-[21.79px] rounded-[4px] sm:w-[154px] sm:text-base hover:bg-transparent hover:border-[#890F21] hover-transition"
                                    >
                                        Try for Free
                                    </button>
                                    <button
                                        ...
                                        className=" hover:bg-primary hover:border-primary text-sm font-semibold text-center w-[158px] h-[44px] sm:h-[56px] border border-white leading-[19.07px] rounded-[4px] sm:leading-[21.79px] sm:w-[183px] sm:text-base hover-transition"
                                    >
                                        Schedule Demo
                                    </button>
                                </div>
                ...
                <div className="bg-[#fff]">
                    <div className="container mx-auto">
                        ...
                        <div className="px-[28.5px] flex justify-between sm:justify-center items-center sm:gap-[15px]">
                            <button
                                onClick={() => router.push("/signup")}
                                className="border border-primary hover:border-[#890F21] text-xs h-[44px] leading-[16.34px] font-semibold text-[#fff] p-[14px_24px] rounded-[3px] bg-primary hover:bg-[#890F21] sm:h-[42px] sm:py-[13px] lg:h-[56px] lg:rounded-[4px] lg:text-base lg:p-[17px_32px] lg:leading-[21.79px] hover-transition hover:text-[#FFFFFF]"
                            >
                                Try for free
                            </button>
                            ...
                            <button
                                ...
                                className="border border-primary text-xs h-[44px] leading-[16.34px] p-[14px_10.5px] font-semibold text-primary rounded-[3px] sm:h-[42px] sm:py-[13px] lg:h-[56px] lg:rounded-[4px] lg:text-base lg:p-[17px_14px] lg:leading-[21.79px] hover-transition hover:text-White hover:bg-primary"
                            >
                                Schedule a demo
                            </button>
                        </div>
                ...
                <div className="bg-[#191919]">
                    <div className="container mx-auto">
                        <div className="flex items-center flex-col py-5 sm:py-[60px] sm:mb-[45px] md:my-[60px] xl:my-[30px]">
                            ...
                            <button
                                onClick={() => router.push("/signup")}
                                className="hover-transition hover:text-[#FFFFFF] hover:bg-transparent hover:border-[#890F21] text-xs leading-[16.34px] font-semibold p-[13px_24px] lg:p-[17px_32px] border border-solid border-primary bg-primary hover:bg-[#890F21] text-center rounder-[3px] lg:text-base lg:leading-[21.79px] text-[#fff] rounded-[4px]"
                            >
                                Get started
                            </button>
                        </div>
                ...
                <div className="bg-[#F8F8F8] hidden">
                    <div className="container mx-auto">
                        ...
                        <div className="px-[28.5px] flex justify-between sm:justify-center items-center sm:gap-[15px]">
                            ...
                            <button
                                onClick={() => router.push("/schedule-demo")}
                                className="hover-transition hover:bg-primary hover:text-White border border-primary text-xs h-[44px] leading-[16.34px] p-[14px_10.5px] font-semibold text-primary rounded-[3px] sm:h-[42px] sm:py-[13px] lg:h-[56px] lg:rounded-[4px] lg:text-base lg:p-[17px_14px] lg:leading-[21.79px]"
                            >
                                Schedule a demo
                            </button>
                        </div>
